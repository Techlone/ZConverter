...
public class ZenTypeLong extends ZenType {
	...
	public void constructCastingRules(IEnvironmentGlobal environment, ICastingRuleDelegate rules, boolean followCasters) {
		rules.registerCastingRule(ZenTypeByte.INSTANCE, new CastingRuleI2B(new CastingRuleL2I(null)));
		rules.registerCastingRule(ZenTypeByteObject.INSTANCE, new CastingRuleStaticMethod(BYTE_VALUEOF, new CastingRuleI2B(new CastingRuleL2I(null))));
		rules.registerCastingRule(ZenTypeShort.INSTANCE, new CastingRuleI2S(new CastingRuleL2I(null)));
		rules.registerCastingRule(ZenTypeShortObject.INSTANCE, new CastingRuleStaticMethod(SHORT_VALUEOF, new CastingRuleI2S(new CastingRuleL2I(null))));
		rules.registerCastingRule(ZenTypeInt.INSTANCE, new CastingRuleL2I(null));
		...
		rules.registerCastingRule(ZenTypeFloat.INSTANCE, new CastingRuleL2F(null));
		...
		rules.registerCastingRule(ZenTypeString.INSTANCE, new CastingRuleStaticMethod(LONG_TOSTRING_STATIC));
